 ...
 */
public class CustomFontBoldTextView extends AppCompatTextView {
    ...
    public CustomFontBoldTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setFont(Context context) {
        ...
        Typeface tf = Typeface.createFromAsset(getContext().getAssets(),
                FontHelper.getFontPath(fontFilename, FontHelper.FONT_TYPE_BOLD));
        setTypeface(tf);
    }
}
